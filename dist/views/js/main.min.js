...
function changePizzaSizes(size){var dx=determineDx(document.querySelector("randomPizzaContainer"),size);var newwidth=(document.querySelector("randomPizzaContainer").offsetWidth+dx)+'px';var pizzaContainer=document.getElementsByClassName("randomPizzaContainer");var lengthContainer=pizzaContainer.length;for(var i=0;i<lengthContainer;i++){pizzaContainer[i].style.width=newwidth;}}
